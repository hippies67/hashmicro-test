                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <div class="col-12">
                                ...
                                <input class="form-control mb-1 money" type="text   " id="jumlah"
                                    placeholder="Masukan Jumlah Bonus" name="jumlah" value="{{ old('jumlah') }}" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <div class="col-12">
                                ...
                                <input class="form-control mb-1 money" type="text" id="edit_jumlah"
                                    placeholder="Masukan Jumlah Bonus" name="jumlah"
                                    value="{{ old('edit_jumlah') }}" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
