                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <div class="col-12">
                                ...
                                <input class="form-control mb-1 money" type="text" id="gajih"
                                placeholder="Masukan Gajih" name="gajih" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <div class="col-12">
                                ...
                                <input class="form-control mb-1 money" type="text" id="edit_gajih"
                                placeholder="Masukan Gajih" name="gajih" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
